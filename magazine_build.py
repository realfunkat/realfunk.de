...
def update_magazine(arts):
 ...
 if 'src="hero-rotation.js' not in s:s=s.replace('</body>','<script defer src="hero-rotation.js?v=20260915-video-once"></script></body>')
 s=re.sub(r'hero-rotation\.js\?v=[^"\']+', 'hero-rotation.js?v=20260915-video-once', s)
