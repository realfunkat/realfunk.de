...
(function () {
  ...
  var css =
    ...
    "#topstories .ts-kick{display:inline-block;min-width:104px;color:var(--accent-dark,#05112A);font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.6px;}" +
